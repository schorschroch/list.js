  ...
  this.get = function (item, valueNames) {
    ...
    for (var i = 0, il = valueNames.length; i < il; i++) {
      ...
      if (valueName.data) {
        ...
        elm = list.utils.getByClass(item.elm, valueName.name, true); //values[valueName.name] = elm ? list.utils.getAttribute(elm, valueName.attr) : ''
        ...
        elm = list.utils.getByClass(item.elm, valueName, true); //values[valueName] = elm ? elm.innerHTML : ''
